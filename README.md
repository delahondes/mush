...
So discussing with ChatGPT, I was able to create a small bash function, that just do a minimal configuration that is fine for me and that is instantly available in all my remote servers (provided they have tmux and mosh, but these two utilities are widespread in the linux world). 

So here it is: add this function in your .bashrc or .bash_profile, make sure mosh and tmux are available on your servers, do your SSH homework (like you should already have done: e.g. copy your SSH key (ssh-add) to the different servers and correctly set up your .ssh/config so you have a nice nickname for all your servers and you don't need to specify user, ports, address).
